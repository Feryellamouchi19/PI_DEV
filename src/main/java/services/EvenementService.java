...
public class EvenementService implements IEvenementService {
    ...
    private String safe(String s) { return s == null ? "" : s.toLowerCase(Locale.ROOT).trim(); }
    private String safeUpper(String s) { return s == null ? "" : s.toUpperCase(Locale.ROOT).trim(); }
}
